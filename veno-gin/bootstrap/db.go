...
func initMysqlGorm() *gorm.DB {
	...
	mysqlConfig := mysql.Config{
		...
		DisableDatetimePrecision:  true,  // 禁用 datetime精度，mysql 5.6 之前的数据库不支持
		DontSupportRenameIndex:    true,  // 命名索引时采用删除并新建的方式，MySQL 5.7 之前的数据库和 MariaDB 不支持重命名索引
