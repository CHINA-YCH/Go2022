...
type Notifier2 interface {
	// AddListener2 添加观察者
	AddListener2(Listener2 Listener2)
	// RemoveListener2 删除观察者
	RemoveListener2(Listener2 Listener2)
	// Notify 通知广播
	Notify(event *Event)
}
...
func (hero *Hero) Fight(another Listener2, baixiao Notifier2) {
...
//添加观察者
func (b *BaiXiao) AddListener2(Listener2 Listener2) {
	b.heroList = append(b.heroList, Listener2)
}

//删除观察者

func (b *BaiXiao) RemoveListener2(Listener2 Listener2) {
...
func (b *BaiXiao) Notify(event *Event) {
	...
	for _, Listener2 := range b.heroList {
		//依次调用全部观察的具体动作
		Listener2.OnFriendBeFight(event)
	}
}
...
func main() {
	...
	baixiao.AddListener2(&hero1)
	baixiao.AddListener2(&hero2)
	baixiao.AddListener2(&hero3)
	baixiao.AddListener2(&hero4)
	baixiao.AddListener2(&hero5)
	baixiao.AddListener2(&hero6)
